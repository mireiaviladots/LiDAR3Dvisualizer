...
root.configure(bg="#1E1E1E")
    ...
    # Frame izquierdo
left_frame_width = 370
screen_height = root.winfo_screenheight()
root.geometry(f"{left_frame_width}x{screen_height}+0+0")
root.left_frame = CTkFrame(root, fg_color="#2E2E2E", corner_radius=0, width=left_frame_width,
                           height=screen_height)
root.left_frame.pack(side="left", fill="y", expand=True)
root.left_frame.pack_propagate(False)

# Frame para los botones del menú
menu_frame = CTkFrame(root.left_frame, fg_color="#2E2E2E", corner_radius=0)
...
# Downsample
downsample_frame = CTkFrame(root.left_frame, fg_color="#2E2E2E", corner_radius=0)
...
# Parameters Button
button_parameters = CTkButton(root.left_frame, text=" ▼ Parameters", text_color="#F0F0F0", fg_color="#3E3E3E",
                              anchor="w", corner_radius=0, command=toggle_parameters)
button_parameters.pack(fill="x", padx=(0, 0), pady=(10, 0))

parameters_frame = CTkFrame(root.left_frame, fg_color="#2E2E2E", corner_radius=0)
...
button_dose_layer = CTkButton(root.left_frame, text=" ▼ Dose Layer", text_color="#F0F0F0", fg_color="#3E3E3E",
                              anchor="w", corner_radius=0, command=toggle_dose_layer_b)
button_dose_layer.pack(fill="x", padx=(0, 0), pady=(10, 0))

# Dose Layer
dose_layer_frame = CTkFrame(root.left_frame, fg_color="#2E2E2E", corner_radius=0)
...
button_extra_computations = CTkButton(root.left_frame, text=" ▼ Extra Computations", text_color="#F0F0F0",
                                      fg_color="#3E3E3E",
                                      anchor="w", corner_radius=0, command=toggle_extra_computations)
button_extra_computations.pack(fill="x", padx=(0, 0), pady=(10, 0))

extra_computations_frame = CTkFrame(root.left_frame, fg_color="#2E2E2E", corner_radius=0)
...
# Visualize
root.btn_visualize = CTkButton(root.left_frame, text="Visualize", text_color="#F0F0F0", fg_color="#1E3A5F",
                               hover_color="#2E4A7F",
